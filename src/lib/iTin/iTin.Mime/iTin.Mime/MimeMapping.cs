...
namespace iTin.Mime
{
    ...
    public static class MimeMapping
    {
        ...
        /// </summary>
        /// <param name="fileExtension">The file extension that is used to determine the <b>MIME</b> type.</param>
        /// <returns>
        ...
        {
            SentinelHelper.ArgumentNull(fileExtension, nameof(fileExtension));

            var extensionWithoutDot = fileExtension.Replace(".", string.Empty);

            var hasMimeMapping = MappingDictionary.TryGetValue(extensionWithoutDot, out var mimeType);
